...
$('.feedback-form').on('submit', function(event) {
        ...
        $.ajax({
            url: '../telegram.php', // Укажите путь к вашему PHP-обработчику
            type: 'POST',
            data: formData,
            success: function(response) {
                // Если успех, скрываем форму и показываем сообщение об успешной отправке
                $('.feedback-wrap').hide();
                $('.feedback-done').show();
            },
            error: function(xhr, status, error) {
                // Если ошибка, вы можете отобразить сообщение об ошибке
